...
export const BRAND_DB: Record<string, BrandDetail> = {
  DeWalt: {
    name: 'DeWalt', initial: 'D', color: '#FCBA00', country: 'EE. UU.',
    models: 4, tools: 86, asg: 73, since: 'MAR·2023',
    rows: [
    ...
    moves: [
      { ts: '29·MAY · 09:12', title: 'Asignación AS-0181', body: 'DCF887 · Jorge Treviño', tone: 'navy' },
      { ts: '27·MAY · 14:40', title: 'Alta de modelo', body: 'DWE1622K agregado al catálogo', tone: 'ok' },
      { ts: '21·MAY · 11:03', title: 'Devolución DV-0140', body: '2× DCD996 · buen estado', tone: 'default' },
    ],
  },
  Makita: {
    name: 'Makita', initial: 'M', color: '#0E7C3A', country: 'Japón',
    models: 3, tools: 32, asg: 22, since: 'MAY·2023',
    rows: [
    ...
    moves: [
      { ts: '28·MAY · 16:20', title: 'Asignación AS-0179', body: 'GA4570 · Luis Cárdenas', tone: 'navy' },
      { ts: '19·MAY · 10:15', title: 'Devolución DV-0136', body: '1× BO5041 · revisión menor', tone: 'warn' },
    ],
  },
  Milwaukee: {
    name: 'Milwaukee', initial: 'M', color: '#D7202C', country: 'EE. UU.',
    models: 2, tools: 18, asg: 16, since: 'JUN·2023',
    rows: [
      { code: 'M18 FUEL', desc: 'Llave de impacto 1/2"', tools: 12, asg: 12 },
      { code: 'M18 GG', desc: 'Engrasadora 18V', tools: 6, asg: 4 },
    ],
    moves: [
      { ts: '30·MAY · 08:05', title: 'Asignación AS-0184', body: 'M18 FUEL · Cuadrilla turno A', tone: 'navy' },
    ],
  },
  Bosch: {
    name: 'Bosch', initial: 'B', color: '#0073B5', country: 'Alemania',
    models: 4, tools: 41, asg: 28, since: 'ABR·2023',
    rows: [
    ...
    moves: [
      { ts: '26·MAY · 13:30', title: 'Devolución DV-0139', body: 'GBH 18V-26 · buen estado', tone: 'default' },
      { ts: '12·MAY · 09:48', title: 'Alta de modelo', body: 'GWS 18V-10 agregado', tone: 'ok' },
    ],
  },
  Fluke: {
    name: 'Fluke', initial: 'F', color: '#FCD600', country: 'EE. UU.',
    models: 1, tools: 10, asg: 1, since: 'AGO·2023',
    rows: [
      { code: '117', desc: 'Multímetro digital TRMS', tools: 10, asg: 1 },
    ],
    moves: [
      { ts: '08·MAY · 15:11', title: 'Asignación AS-0162', body: 'Fluke 117 · Laboratorio', tone: 'navy' },
    ],
  },
}
