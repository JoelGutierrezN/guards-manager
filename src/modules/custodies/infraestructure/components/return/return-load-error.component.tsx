...
const FALLBACK_MESSAGE = 'No pudimos preparar la devolución. Inténtalo de nuevo.'

export function ReturnLoadError({ message, notFound, onRetry, onBack }: Props): JSX.Element {
  return (
    <div className="reveal-d1 mx-auto w-full max-w-[720px] overflow-hidden rounded-[26px] border border-hairline bg-white shadow-[0_1px_2px_rgba(14,15,60,0.04)]">
      <Empty
        icon={Alert02Icon}
        title={notFound ? 'Resguardo no encontrado' : 'Devolución no disponible'}
