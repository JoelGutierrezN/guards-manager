...
import type { EmployeesTableColumn } from './employees-table-columns.model'

interface Props {
  column: EmployeesTableColumn
}

export function EmployeesTableHeaderCell({ column }: Props): JSX.Element {
